    ...
    <div className="home">
      ...
      <div className="d-flex planets">
        {store.planetProperties.map((value, index) => {
          return (
            <div className="card col-2 m-4 border-0" key={index}>
                    ...
                    alt="Bootstrap"
                  />
              <div className="card-body"><h5 className="card-title text-center text-warning">{value.name}</h5><div className="row m-2 p-0 ">
                ...
                if (typeof value[key] != "object")
                  return (
                    <p className="text-start text-secondary bg-dark" key={y}>
                     {/*} {key + " : " + value[key] */} 
                   {/*         </p>  
                );
              })}        */} 
